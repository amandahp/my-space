		...
		<Container>
			<Section>
				...
				<TextBlock style={{ padding: '4rem 0rem 0rem 0rem' }}>
					...
					<h2>{position}</h2>
					<a href={linkedin} target="_blank" rel="noopener noreferrer"><Image src="/utils/icon/linkedin-svgrepo-com.svg" alt="Linkedin" width={20}
						height={20} /></a>
					<a href={github} target="_blank" rel="noopener noreferrer"><Image src="/utils/icon/git-svgrepo-com.svg" alt="Github" width={20}
						height={20} /></a>
				</TextBlock>
			</Section>
